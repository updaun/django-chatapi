...
class MessageSerializer(serializers.ModelSerializer):
    ...
    def get_sender_data(self, object):
        from user_control.serializers import UserProfileSerializer
        return UserProfileSerializer(object.sender.user_profile).data

    def get_receiver_data(self, object):
        from user_control.serializers import UserProfileSerializer
        return UserProfileSerializer(object.receiver.user_profile).data